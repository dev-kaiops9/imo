...
function setStatus(msg, isError) {
  ...
  statusMsg.classList.toggle('text-slate-500', !isError);
}
...
function metaRow(label, value) {
  return '<div class="text-slate-400">' + label + '</div><div class="font-semibold text-slate-700 text-right">' + value + '</div>';
}
